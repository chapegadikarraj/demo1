   ...
   stages {
      ...
      stage('Deploy to Tomcat'){
          steps {
            ...
            //}
            sh "curl -v -u admin:admin -T /var/lib/jenkins/workspace/demo1_main/target/Demo1-0.0.1-SNAPSHOT.jar 'http://ec2-3-136-234-222.us-east-2.compute.amazonaws.com:8080//manager/text/deploy?path=/demo1'"
