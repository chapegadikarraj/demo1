   ...
   stages {
      ...
      stage('Deploy to Tomcat'){
          steps {
            ...
            //}
            sh "curl -v -u admin:admin -T /var/lib/jenkins/workspace/demo-multibranch-github_main/target/Demo1-0.0.1-SNAPSHOT.jar 'ec2-18-217-214-107.us-east-2.compute.amazonaws.com:8080//manager/text/deploy?path=/demo1'"
